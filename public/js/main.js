...
document.addEventListener('DOMContentLoaded', function () {
    ...
    about_h2_1.addEventListener('click', function () {
        ...
        about_box_1.style.animation = 'rotation 1s linear';
    ...
    about_h2_2.addEventListener('click', function () {
        ...
        about_box_2.style.animation = 'rotation 1s linear';
    ...
    about_h2_3.addEventListener('click', function () {
        ...
        about_box_3.style.animation = 'rotation 1s linear';
    ...
    about_h2_4.addEventListener('click', function () {
        ...
        about_box_4.style.animation = 'rotation 1s linear';
